...
class CreateAccountBackendEvent implements ObserverInterface
{
    ...
    {
        $this->logger->info('In CreateAccountBackendEvent');

        $CREATE_ACCOUNT_EVENT = '$create_account'; //Name of the event
        ...
        // TODO: add detail
        $this->logger->info('In CreateAccountBackendEvent; TODO');
    }
